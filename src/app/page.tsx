            ...
            <div className="space-y-8 text-center lg:text-left">
              <div className="space-y-6">
                ...
                <p className="text-lg sm:text-xl text-slate-400 leading-relaxed max-w-xl mx-auto lg:mx-0">
                  BiasMapper empowers journalists, researchers, and critical thinkers to detect, analyze, and understand ideological and cognitive biases across media sources.
                </p>
              ...
              <Card className="relative bg-slate-900/80 backdrop-blur-xl border-slate-700/50 shadow-2xl overflow-hidden">
                ...
                <div className="bg-gradient-to-r from-slate-800 to-slate-800/50 px-6 py-4 border-b border-slate-700/50">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-xs text-slate-500 font-mono">bias-mapper.framework</span>
                  </div>
                </div>
                ...
                <CardContent className="p-6 sm:p-8">
                  ...
                  <div className="grid grid-cols-7 gap-2 gap-y-3 mb-6">
                    ...
                    <div className="col-start-4 row-start-1">
                      <div
                        className="aspect-square rounded-lg flex items-center justify-center text-white font-bold text-xs cursor-pointer hover:scale-110 transition-transform shadow-lg"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-slate-400 max-w-2xl mx-auto">
              Comprehensive tools for understanding and analyzing media bias across multiple dimensions.
            </p>
          </div>
            ...
            {features.map((feature, index) => (
              ...
              >
                ...
                <CardContent className="relative p-8">
                  <div className={`w-14 h-14 rounded-xl bg-gradient-to-br ${feature.color} flex items-center justify-center mb-6 shadow-lg ${feature.shadowColor} group-hover:scale-110 transition-transform duration-300`}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {capabilities.map((cap, i) => (
              <Card key={i} className="group bg-slate-800/30 border-slate-700/50 hover:border-slate-600 transition-all duration-300 hover:-translate-y-1">
                <CardContent className="pt-6">
                  <div className="flex items-start justify-between mb-4">
                    ...
                    <div className="text-right">
                      <div className="text-xl font-bold text-white">{cap.stat}</div>
                      <div className="text-[10px] text-slate-500 uppercase tracking-wider">{cap.statLabel}</div>
                    </div>
                  </div>
                  <h4 className="font-bold text-white mb-2 group-hover:text-blue-400 transition-colors">{cap.title}</h4>
      ...
      <section className="relative py-24 sm:py-32">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-slate-400 max-w-2xl mx-auto">
              Three simple steps to analyze and understand bias in any text content.
            </p>
          </div>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <Card className="relative overflow-hidden bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 border-0 shadow-2xl">
            ...
            <div className="absolute inset-0 opacity-10">
              <div className="absolute inset-0 bg-[radial-gradient(circle_at_1px_1px,rgba(255,255,255,0.5)_1px,transparent_1px)]" style={{ backgroundSize: "40px 40px" }} />
            </div>
            ...
            <CardContent className="relative p-12 sm:p-16 text-center">
              ...
              <p className="text-lg sm:text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
                Start analyzing media bias today. Join thousands of journalists, researchers, and critical thinkers using BiasMapper.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            ...
            <div className="md:col-span-2">
              ...
              <p className="text-slate-400 text-sm leading-relaxed max-w-md">
                Fair and balanced analysis across perspectives using advanced AI technology. 
                Empowering critical thinkers to understand media narratives.
              </p>
            </div>
          ...
          <div className="mt-8 pt-8 border-t border-slate-800 text-center">
            <p className="text-xs text-slate-600">
              BiasMapper provides directional classification as a guide, not absolute truth. 
              Always review and validate content in context.
            </p>
          </div>
        </div>
      </footer>
